            ...
            if ($request->input('Id_prepiedad') != null) {
                ...
                if($request->hasFile('imagen')) {
                    ...
                    ->update(['PROPIEDADES_NOMBRE' => $request->input('propiedad'),
                        ...
                        'PROPIEDADES_MONEDA' => $request->input('moneda'),
                        ...
                        'PROPIEDADES_TERRENO_TAMAÑO' => $request->input('TerrenoTamaño'),
                        'PROPIEDADES_CONSTRUCCION' => $request->input('Construcción'),
                        'PROPIEDADES_CONSTRUCCION_TAMAÑO' => $request->input('ConstruccionTamaño'),
                        ...
                        'PROPIEDADES_CUOTA_MONEDA' => $request->input('CuotaMoneda'),
