...
<body>
    <h1>{{$propiedades[0]->PROPIEDADES_TIPO.' en '.$propiedades[0]->PROPIEDADES_OPERACION}} </h1>
<div>
    <div >
        <h1>
...
<img style="width: 400px;height: 250px;" src="{{asset(Storage::url($propiedades[0]->PROPIEDADES_IMAGEN))}}">
    <div>
