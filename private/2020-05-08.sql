...
CREATE DATABASE IF NOT EXISTS `compraventa` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `compraventa`;

-- Volcando estructura para tabla compraventa.cv_contactos
...
-- Volcando datos para la tabla compraventa.cv_contactos: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla compraventa.cv_imagenes
...
-- Volcando datos para la tabla compraventa.cv_imagenes: ~131 rows (aproximadamente)
...
-- Volcando estructura para tabla compraventa.cv_inicio
...
-- Volcando datos para la tabla compraventa.cv_inicio: ~0 rows (aproximadamente)
...
-- Volcando estructura para tabla compraventa.cv_propiedades
CREATE TABLE IF NOT EXISTS `cv_propiedades` (
  ...
  `PROPIEDADES_PRECIO` double DEFAULT NULL,
...
-- Volcando datos para la tabla compraventa.cv_propiedades: ~10 rows (aproximadamente)
...
INSERT INTO `cv_propiedades` (`PROPIEDADES_ID`, `PROPIEDADES_NOMBRE`, `PROPIEDADES_PAIS`, `PROPIEDADES_ESTADO`, `PROPIEDADES_MUNICIPIO`, `PROPIEDADES_COLONIA`, `PROPIEDADES_ZONA`, `PROPIEDADES_CP`, `PROPIEDADES_CALLE`, `PROPIEDADES_EXTERIOR`, `PROPIEDADES_INTERIOR`, `PROPIEDADES_IMAGEN`, `PROPIEDADES_MAPA`, `PROPIEDADES_TIPO`, `PROPIEDADES_SUBTIPO`, `PROPIEDADES_OPERACION`, `PROPIEDADES_PRECIO`, `PROPIEDADES_HABITACIONES`, `PROPIEDADES_BAÑOS`, `PROPIEDADES_MEDIO_BAÑO`, `PROPIEDADES_TERRENOS`, `PROPIEDADES_CONSTRUCCION`, `PROPIEDADES_CONDICIONES`, `PROPIEDADES_AÑO`, `PROPIEDADES_NIVELES`, `PROPIEDADES_ESTACIONAMIENTO`, `PROPIEDADES_CUOTA`, `PROPIEDADES_DESCRIPCION`, `PROPIEDADES_CLAVE`, `PROPIEDADES_VIDEO`, `PROPIEDADES_LATITUD`, `PROPIEDADES_LONGITUD`) VALUES
	(1, 'VENTA DE CASA EN PLAYA LINDA, VERACRUZ, VER.', 'Mexico', 1, 28, 'Playa Linda', 'Norte', 91810, 'Playa Linda Veracruz', 0, 14, '1586484306WhatsApp Image 2020-04-03 at 20.11.23.jpeg', NULL, 'Casa', 'Sola', 'Venta', 500, 2, 1, 1, '65m2', '80 m2', 'Buena', 2000, 2, 1, NULL, 'Planta Baja\r\n\r\nGarage para dos autos.\r\nSala – comedor\r\nCocina\r\nMedio baño\r\nPatio de servicio\r\n\r\nPlanta Alta\r\nDos recamaras\r\nUn baño comun', 'AI CV 0005', NULL, 19.2174, -96.1795),
	(3, 'CASA EN VENTA EN FRACC TAMPIQUERA, BOCA DEL RIO, VER.', 'Mexico', 1, 28, 'Boca del Rio', 'Norte', 94290, 'Coatzacoalcos 58, entre paseo Boca del Rio y Paseo Pescadores', 58, 0, '1586484729WhatsApp Image 2020-04-03 at 20.12.04.jpeg', NULL, 'Casa', 'Sola', 'Venta', 100000, 2, 2, 2, '260 m2', '240 m2', 'Buena', NULL, 1, 1, NULL, 'UN NIVEL\r\n•	Garage techado para 3 autos\r\n•	Sala\r\n•	Comedor\r\n•	Cocina\r\n•	Medio baño de visitas\r\n•	2 recamaras con baño cada una\r\n•	Cuarto de servicio con baño', 'AI CV 0006', NULL, NULL, NULL),
	(4, 'VENTA DE CASA EN NUEVA ERA A UNA CALLE DE JUAN PABLO II, BOCA DEL RIO VER.', 'Mexico', 1, 28, 'Boca del Rio', 'Nueva Era', 94290, 'A UNA CALLE DE JUAN PABLO II', 230, 0, '15864840242.13.jpeg', NULL, 'Casa', 'Sola', 'Venta', 12000, 3, 3, 3, '130 m2', '210 m2', 'Buena', 2020, 2, 2, NULL, 'PLANTA BAJA:\r\n•	Garage 2 autos\r\n•	Sala\r\n•	Comedor\r\n•	Cocina Integral con barra\r\n•	Jardin\r\n•	Medio Baño\r\nPLANTA ALTA:\r\n•	3 Recamaras con baño y closet\r\n•	Sala de TV\r\nCARACTERISTICAS:\r\n•	Cisterna con bomba\r\n•	Portón automático\r\n•	calentador', 'AI CV 0003', NULL, NULL, NULL),
	(5, 'VENTA DE CASA COL PRIMERO DE MAYO NORTE', 'Mexico', 1, 17, 'Lazaro Cardenas', 'Boca de Rio', 94298, 'Lazaro Cardenas 395-A, Boca de Rio, Ver', 395, NULL, '1586540798WhatsApp Image 2020-04-07 at 21.54.25.jpeg', NULL, 'Casa', 'Sola', 'Venta', 8000, 3, 2, NULL, '126 m2', '125.20 m2', 'Buena', NULL, 2, 2, NULL, 'PLANTA BAJA\r\n•	Sala\r\n•	Comedor\r\n•	Cocina\r\n•	Recamara\r\n•	Baño completo\r\n•	Área de servicio cubierta\r\nPLANTA ALTA\r\n•	Dos recamaras con vestidor y baño\r\n•	Balcón\r\nCuenta con: \r\n•	protecciones planta baja\r\n•	cisterna con bomba\r\n•	cocina integral\r\n•	climatizada sala-comedor y las 3 recamaras', 'AI CV 0004', NULL, NULL, NULL),
	(6, 'VENTA DE CASA EN FRACC LAS PALMAS, MEDELLIN, VER.', 'Mexico', 1, 18, 'Medellín de Bravo, Ver.', 'Norte', 94273, 'Fracc las Palmas Privada 18 lote 12, Medellín de Bravo, Ver.', 18, 12, '1586541310WhatsApp Image 2020-04-07 at 21.56.23.jpeg', NULL, 'Casa', 'Sola', 'Venta', 20000, 5, 3, 1, '240 m2 (12 x 20)', '360.06 m2', 'Buena', 2020, 2, 2, NULL, 'PLANTA BAJA:\r\n•	Garage 2 autos\r\n•	Closet de herramientas\r\n•	Jardin\r\n•	Terraza\r\n•	Vestibulo de acceso\r\n•	½ baño\r\n•	Estancia (doble altura)\r\n•	Comedor (jardín interior)\r\n•	Cocina\r\n•	Cuarto de lavado\r\n•	Patio de tendido\r\n•	Cuarto de servicio con baño\r\nPLANTA ALTA:\r\n•	Vestibulo (closet de blancos y séptico)\r\n•	Sala de TV\r\n•	Recamara principal con Vestidor, baño y balcón\r\n•	Recamara 2 con baño y closet\r\n•	Recamara 3 con vestidor, baño y balcón', 'AI 0006', NULL, NULL, NULL),
	(7, 'VENTA DE CASA EN RESIDENCIAL DEL BOSQUE, VERACRUZ, VER', 'Mexico', 1, 18, 'Bosque Veracruz', 'Norte', 91697, 'Esta camino a Tejeria', 0, NULL, '1586541742WhatsApp Image 2020-04-07 at 22.04.57.jpeg', NULL, 'Casa', 'Sola', 'Venta', 45000, 3, 2, NULL, '8.00 x 15.00 = 120 m2', '118.35 m2', 'Buena', NULL, 2, 2, NULL, 'PLANTA BAJA:\r\n•	Garage 2 autos\r\n•	Sala\r\n•	Comedor\r\n•	Baño completo\r\n•	Cocina integral\r\n•	Patio de servicio\r\n•	Jardín\r\n\r\nPLANTA ALTA:\r\n•	3 recamaras\r\n•	Un baño completo\r\nCasa en  esquina con excedente de terreno, muros con acabados pulido espejo, antique y piedras, pisos de cerámico. (acabados de lujo)', 'AI CV 0007', NULL, NULL, NULL),
	(8, 'VENTA DE HERMOSA RESIDENCIA EN FRACC PALMAS GREEEN, MEDELLIN, VER', 'Mexico', 1, 18, 'Medellín de Bravo, Ver', 'Norte', 94274, 'Fracc Green Cangrejo 57, Medellín de Bravo, Ver.', 57, NULL, '1586542175WhatsApp Image 2020-04-07 at 22.05.18.jpeg', NULL, 'Casa', 'Sola', 'Venta', 2000, 5, 4, 1, '500 m2', '569.62 m2', 'Buena', 2020, 2, 4, NULL, 'PLANTA BAJA:\r\n•	Garage 4 autos\r\n•	Closet de herramientas\r\n•	Jardín\r\n•	Alberca de 3.00 x 11.00 m\r\n•	Asador\r\n•	Terraza techada 4.40 x 9.55 mts\r\n•	Terraza abierta 3.60 x 4.30 mts con asador, tarja, barra de preparación\r\n•	Vestíbulo de acceso, con closet \r\n•	½ baño\r\n•	Cuarto de usos múltiples ( Recamara, oficina, sala de TV, etc)\r\n•	Estancia (doble altura 6.04 m.)\r\n•	Comedor (doble altura 6.04 m.)\r\n•	Cocina integral equipada, despensa\r\n•	Cuarto de lavado (calentador)\r\n•	Patio de tendido\r\n•	Cuarto de servicio con baño\r\n\r\nPLANTA ALTA:\r\n•	Vestíbulo (closet de blancos y séptico)\r\n•	Sala de TV o Estudio\r\n•	Bodega\r\n•	Recamara Principal 3.50m altura, con Vestidor, baño, balcón calle, balcón jardín, patio de tendido\r\n•	Recamara 2 altura 3.50m  con vestidor y  baño, con vista al jardín\r\n•	Recamara 3 altura 3.50 m con vestidor y baño, con vista al jardín\r\n\r\nCARACTERISTICAS\r\n•	Cisterna 5000 lts\r\n•	Bomba sumergible\r\n•	Hidroneumático\r\n•	Calentador 2\r\n•	Acceso secundario', 'AI CV 0008', NULL, NULL, NULL),
	(9, 'FRACCIONAMIENTO “JARDINES DEL SUR” PASO DEL TORO, MEDELLIN VERACRUZ', 'Mexico', 1, 28, 'Boca del Río-Paso del Toro', 'Jardines del Sur', 94277, 'A sólo cinco minutos de Plaza el Dorado, Km. 7 Boulevard Boca del Río-Paso del Toro', 0, NULL, '1586542700WhatsApp Image 2020-04-07 at 22.06.50.jpeg', NULL, 'Casa', 'Sola', 'Venta', 3000, 3, 2, 2, '6x14=84m2', '113 m²', 'Buena', NULL, 2, 1, NULL, 'PLANTA BAJA:\r\n•	Sala\r\n•	Comedor\r\n•	Medio baño\r\n•	Cocina \r\n•	Área de lavado\r\n•	Jardín\r\n•	Estacionamiento\r\nPLANTA ALTA:\r\n•	Dos recámaras con clóset cada una, comparten baño\r\n•	Recámara principal con baño y closet\r\nLa madera de clósets y puertas es de Cedro con Caobilla\r\nAMENIDADES\r\n•	Alberca\r\n•	Gimnasio\r\n•	Palapas\r\n•	Cancha de fútbol cinco\r\n•	Área de asadores\r\n•	Área de mascotas\r\n•	Vigilancia las 24 horas\r\n•	Vialidades de concreto\r\nInstalaciones eléctricas, de televisión y de cable subterráneas', 'AI CV 0009', NULL, NULL, NULL),
	(10, 'CASAS ESTILO CAMPESTRE VILLAS SAN JOSE EN SAN JOSE NOVILLERO, EN BOCA DEL RIO, VER', 'Mexico', 1, 17, 'BOCA DEL RIO, VER', 'Norte', 94277, 'SAN JOSE NOVILLERO', 0, NULL, '1586543742WhatsApp Image 2020-04-07 at 22.09.51.jpeg', NULL, 'Casa', 'Sola', 'Venta', 600000, 3, 4, NULL, '152 m2', '126 m2', 'Buena', NULL, 2, 1, NULL, 'PLANTA BAJA:\r\n•	Sala\r\n•	Comedor\r\n•	Cocina\r\n•	Una recámara\r\n•	Un baño completo\r\n•	Area de lavado\r\n•	Patio\r\n•	Estacionamiento\r\n•	Jardin\r\n\r\nPLANTA ALTA:\r\n•	2 recamaras con baño cada una\r\n•	Terraza\r\n\r\nAREAS COMUNES\r\n•	Jardines\r\n•	Alberca\r\n•	Asadores\r\n•	Baños en areas de alberca y asadores\r\n•	Vigilancia 24/7', 'AI CV 0010', NULL, NULL, NULL),
	(11, 'CASA EN VENTA INFONAVIT BUENA VISTA, VERACRUZ, VER.', 'Mexico', 1, 18, 'Buena Vista', 'Norte', 94277, 'Buena Vista', 0, NULL, '1586544217WhatsApp Image 2020-04-07 at 22.10.50.jpeg', NULL, 'Casa', 'Sola', 'Venta', 300000, 3, 1, NULL, '5.00 x 15.00 m.=75 m2', '105.00 m2', 'Buena', NULL, 2, NULL, NULL, 'PLANTA BAJA:\r\n•	Sala\r\n•	Comedor\r\n•	Cocina\r\n•	Patio se servicio\r\n\r\nPLANTA ALTA:\r\n•	3 recamaras\r\n•	Un baño\r\n•	Área de estudio\r\n•	Balcón', 'AI CV 0011', NULL, NULL, NULL);
/*!40000 ALTER TABLE `cv_propiedades` ENABLE KEYS */;

-- Volcando estructura para tabla compraventa.cv_tipos
...
-- Volcando datos para la tabla compraventa.cv_tipos: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla compraventa.migrations: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla compraventa.users: ~2 rows (aproximadamente)
